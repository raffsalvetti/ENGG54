...
MEMORY
{
 PAGE 0:  /* ---- Unified Program/Data Address Space ---- */
  ...
  SAMP_0 (RWIX): origin = 0x010000, length = 0x010000
  SAMP_1 (RWIX): origin = 0x020000, length = 0x010000
  SAMP_2 (RWIX): origin = 0x030000, length = 0x010000
  SAMP_3 (RWIX): origin = 0x040000, length = 0x010000
  SAMP_4 (RWIX): origin = 0x050000, length = 0x010000
  SAMP_5 (RWIX): origin = 0x060000, length = 0x010000
  SAMP_6 (RWIX): origin = 0x070000, length = 0x010000
  SAMP_7 (RWIX): origin = 0x080000, length = 0x010000
  SAMP_8 (RWIX): origin = 0x090000, length = 0x010000
  SAMP_9 (RWIX): origin = 0x0A0000, length = 0x010000
  SAMP_10 (RWIX): origin = 0x0B0000, length = 0x010000
  SAMP_11 (RWIX): origin = 0x0C0000, length = 0x010000
  EMPTY  (RWIX): origin = 0x0D0000, length = 0x010000
...
SECTIONS
{
   ...
   .args     >  DARAM align(32) fill = 00h           
    ...
    .samp_0   >  SAMP_0 align(16) fill = 00h
	.samp_1   >  SAMP_1 align(16) fill = 00h
	.samp_2   >  SAMP_2 align(16) fill = 00h
	.samp_3   >  SAMP_3 align(16) fill = 00h
	.samp_4   >  SAMP_4 align(16) fill = 00h
	.samp_5   >  SAMP_5 align(16) fill = 00h
	.samp_6   >  SAMP_6 align(16) fill = 00h
	.samp_7   >  SAMP_7 align(16) fill = 00h
	.samp_8   >  SAMP_8 align(16) fill = 00h
	.samp_9   >  SAMP_9 align(16) fill = 00h
	.samp_10   >  SAMP_10 align(16) fill = 00h
	.samp_11   >  SAMP_11 align(16) fill = 00h

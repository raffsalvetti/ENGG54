...
MEMORY
{
 PAGE 0:  /* ---- Unified Program/Data Address Space ---- */
  ...
  //CE0    (RWIX): origin = 0x010000, length = 0x3F0000  /* 4M minus 64K Bytes */
  TABLE0   (RWIX): origin = 0x010000, length = 0x020000
  SIGNAL0   (RWIX): origin = 0x030000, length = 0x020000
  SIGNAL1   (RWIX): origin = 0x050000, length = 0x020000
  SIGNAL2   (RWIX): origin = 0x070000, length = 0x020000
  SIGNAL3   (RWIX): origin = 0x090000, length = 0x020000
  SIGNAL4   (RWIX): origin = 0x0B0000, length = 0x020000
  SIGNAL5   (RWIX): origin = 0x0D0000, length = 0x020000
  SIGNAL6   (RWIX): origin = 0x0F0000, length = 0x020000
  SIGNAL7   (RWIX): origin = 0x110000, length = 0x020000
  EMPTY     (RWIX): origin = 0x130000, length = 0x2D0000
...
SECTIONS
{
   ...
   .table0   >  TABLE0 align(16)	fill = 00h
   .signal0	 >	SIGNAL0 align(16)	fill = 00h
   .signal1	 >	SIGNAL1 align(16)	fill = 00h
   .signal2	 >	SIGNAL2 align(16)	fill = 00h
   .signal3	 >	SIGNAL3 align(16)	fill = 00h
   .signal4	 >	SIGNAL4 align(16)	fill = 00h
   .signal5	 >	SIGNAL5 align(16)	fill = 00h
   .signal6	 >	SIGNAL6 align(16)	fill = 00h
   .signal7	 >	SIGNAL7 align(16)	fill = 00h
